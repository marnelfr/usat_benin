...
-- Dumping structure for table usat_benin2.agent
CREATE TABLE IF NOT EXISTS `agent` (
  ...
  `register_num` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
  CONSTRAINT `FK_268B9C9DBF396750` FOREIGN KEY (`id`) REFERENCES `user` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table usat_benin2.agent: ~6 rows (approximately)
/*!40000 ALTER TABLE `agent` DISABLE KEYS */;
INSERT INTO `agent` (`id`, `compagny`, `ifu`, `register_num`) VALUES
	(3, 'Corp UK', '23dsf65fe6z5ff16', 'ds6f54ds64f56ds4f65sd'),
	(13, 'ADE SARL', '5115645d4846dsq', '5s6d4fsfd8ds64f'),
	(37, 'ADE SARL', '5115645gfhgd4846', '5s6d4fsfd864ffgfd'),
	(40, 'Group Trans', '65656848486', '648684486486'),
	(41, 'ADE SARL', NULL, NULL),
	(43, 'DADA Sarl', NULL, NULL);
/*!40000 ALTER TABLE `agent` ENABLE KEYS */;

-- Dumping structure for table usat_benin2.bank
...
-- Dumping data for table usat_benin2.bank: ~2 rows (approximately)
...
-- Dumping structure for table usat_benin2.brand
...
-- Dumping data for table usat_benin2.brand: ~131 rows (approximately)
...
-- Dumping structure for table usat_benin2.condition
CREATE TABLE IF NOT EXISTS `condition` (
  ...
  `created_at` datetime NOT NULL,
  PRIMARY KEY (`id`),
  KEY `IDX_BDD68843A76ED395` (`user_id`),
  CONSTRAINT `FK_BDD68843A76ED395` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table usat_benin2.condition: ~0 rows (approximately)
...
-- Dumping structure for table usat_benin2.demande_file
CREATE TABLE IF NOT EXISTS `demande_file` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `removal_id` int(11) DEFAULT NULL,
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `UNIQ_EB3A44C593CB796C` (`file_id`),
  KEY `IDX_EB3A44C5A00B94E6` (`removal_id`),
  KEY `IDX_EB3A44C5537048AF` (`transfer_id`),
  KEY `IDX_EB3A44C5545317D1` (`vehicle_id`),
  KEY `IDX_EB3A44C5E54D128A` (`remover_id`),
  CONSTRAINT `FK_EB3A44C5537048AF` FOREIGN KEY (`transfer_id`) REFERENCES `transfer` (`id`),
  CONSTRAINT `FK_EB3A44C5545317D1` FOREIGN KEY (`vehicle_id`) REFERENCES `vehicle` (`id`),
  CONSTRAINT `FK_EB3A44C593CB796C` FOREIGN KEY (`file_id`) REFERENCES `file` (`id`),
  CONSTRAINT `FK_EB3A44C5A00B94E6` FOREIGN KEY (`removal_id`) REFERENCES `removal` (`id`),
  CONSTRAINT `FK_EB3A44C5E54D128A` FOREIGN KEY (`remover_id`) REFERENCES `remover` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=84 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table usat_benin2.demande_file: ~81 rows (approximately)
/*!40000 ALTER TABLE `demande_file` DISABLE KEYS */;
INSERT INTO `demande_file` (`id`, `removal_id`, `transfer_id`, `file_id`, `used_for`, `deleted`, `created_at`, `vehicle_id`, `remover_id`) VALUES
	(1, NULL, 11, 13, 'bol', 0, '2020-08-16 21:11:09', 18, NULL),
	(2, 11, NULL, 57, 'bfu', 0, '2020-08-18 22:28:54', NULL, NULL),
	(3, 11, NULL, 58, 'entry', 0, '2020-08-18 22:28:54', NULL, NULL),
	(4, 11, NULL, 59, 'receipt', 0, '2020-08-18 22:28:54', NULL, NULL),
	(5, 10, NULL, 60, 'bfu', 0, '2020-08-20 00:34:15', NULL, NULL),
	(6, NULL, NULL, 61, 'bol', 0, '2020-08-20 01:02:05', 46, NULL),
	(7, NULL, NULL, 62, 'bol', 0, '2020-08-20 01:06:14', 47, NULL),
	(8, 12, NULL, 64, 'bfu', 0, '2020-08-20 01:07:30', NULL, NULL),
	(9, 12, NULL, 65, 'entry', 0, '2020-08-20 01:07:30', NULL, NULL),
	(10, 12, NULL, 66, 'receipt', 0, '2020-08-20 01:07:30', NULL, NULL),
	(11, NULL, NULL, 67, 'bol', 0, '2020-08-20 01:19:01', 48, NULL),
	(12, 13, NULL, 69, 'bfu', 0, '2020-08-20 01:19:55', NULL, NULL),
	(13, 13, NULL, 70, 'entry', 0, '2020-08-20 01:19:55', NULL, NULL),
	(14, 13, NULL, 71, 'receipt', 0, '2020-08-20 01:19:55', NULL, NULL),
	(15, NULL, NULL, 72, 'bol', 0, '2020-08-20 01:25:07', 49, NULL),
	(16, 14, NULL, 74, 'bfu', 0, '2020-08-20 01:26:01', NULL, NULL),
	(17, 14, NULL, 75, 'entry', 0, '2020-08-20 01:26:02', NULL, NULL),
	(18, 14, NULL, 76, 'receipt', 0, '2020-08-20 01:26:02', NULL, NULL),
	(19, NULL, NULL, 77, 'bol', 0, '2020-08-20 01:29:11', 50, NULL),
	(20, 15, NULL, 83, 'bfu', 0, '2020-08-20 01:30:01', NULL, NULL),
	(21, 15, NULL, 80, 'entry', 0, '2020-08-20 01:30:01', NULL, NULL),
	(22, 15, NULL, 81, 'receipt', 0, '2020-08-20 01:30:01', NULL, NULL),
	(23, NULL, NULL, 82, 'bol', 0, '2020-08-20 01:32:25', 50, NULL),
	(24, NULL, NULL, 84, 'bol', 0, '2020-08-20 01:36:16', 50, NULL),
	(25, NULL, NULL, 85, 'bol', 0, '2020-08-22 21:16:35', 51, NULL),
	(26, NULL, NULL, 86, 'bol', 0, '2020-08-23 10:41:07', 52, NULL),
	(27, NULL, NULL, 87, 'bol', 0, '2020-08-24 21:47:04', 53, NULL),
	(28, 16, NULL, 93, 'bfu', 0, '2020-08-24 21:48:35', NULL, NULL),
	(29, 16, NULL, 94, 'entry', 0, '2020-08-24 21:48:35', NULL, NULL),
	(30, 16, NULL, 95, 'receipt', 0, '2020-08-24 21:48:36', NULL, NULL),
	(31, NULL, NULL, 92, 'bol', 0, '2020-08-25 21:32:22', 53, NULL),
	(32, NULL, NULL, 99, 'bol', 0, '2020-08-25 22:01:16', 54, NULL),
	(33, NULL, 1, 102, 'assurance', 0, '2020-08-26 19:16:39', NULL, NULL),
	(34, NULL, 6, 103, 'assurance', 0, '2020-08-26 19:19:50', NULL, NULL),
	(35, NULL, 7, 104, 'assurance', 0, '2020-08-26 19:21:32', NULL, NULL),
	(36, NULL, NULL, 105, 'bol', 0, '2020-08-28 23:25:46', 55, NULL),
	(37, NULL, NULL, 108, 'bol', 0, '2020-08-29 01:02:24', 56, NULL),
	(38, NULL, NULL, 109, 'bol', 0, '2020-08-29 01:19:55', 57, NULL),
	(39, NULL, NULL, 110, 'cin', 0, '2020-08-29 01:29:42', NULL, 16),
	(40, 17, NULL, 111, 'bfu', 0, '2020-08-29 01:30:01', NULL, NULL),
	(41, 17, NULL, 112, 'entry', 0, '2020-08-29 01:30:01', NULL, NULL),
	(42, 17, NULL, 113, 'receipt', 0, '2020-08-29 01:30:02', NULL, NULL),
	(43, NULL, 16, 114, 'assurance', 0, '2020-08-29 02:59:54', NULL, NULL),
	(44, NULL, NULL, 115, 'bol', 0, '2020-08-29 12:21:57', 58, NULL),
	(45, NULL, NULL, 116, 'bol', 0, '2020-08-29 12:41:52', 59, NULL),
	(46, NULL, NULL, 117, 'cin', 0, '2020-08-29 12:42:48', NULL, 17),
	(47, 18, NULL, 118, 'bfu', 0, '2020-08-29 12:42:59', NULL, NULL),
	(48, 18, NULL, 119, 'entry', 0, '2020-08-29 12:43:00', NULL, NULL),
	(49, 18, NULL, 120, 'receipt', 0, '2020-08-29 12:43:00', NULL, NULL),
	(50, NULL, NULL, 121, 'bol', 0, '2020-08-30 09:11:23', 60, NULL),
	(51, NULL, NULL, 122, 'cin', 0, '2020-08-30 09:13:02', NULL, 18),
	(52, NULL, NULL, 123, 'bol', 0, '2020-08-30 09:13:53', 61, NULL),
	(53, NULL, NULL, 124, 'cin', 0, '2020-08-30 09:14:35', NULL, 19),
	(54, 19, NULL, 125, 'bfu', 0, '2020-08-30 09:14:47', NULL, NULL),
	(55, 19, NULL, 126, 'entry', 0, '2020-08-30 09:14:48', NULL, NULL),
	(56, 19, NULL, 127, 'receipt', 0, '2020-08-30 09:14:48', NULL, NULL),
	(57, 20, NULL, 128, 'bfu', 0, '2020-08-30 09:17:01', NULL, NULL),
	(58, 20, NULL, 129, 'entry', 0, '2020-08-30 09:17:02', NULL, NULL),
	(59, 20, NULL, 130, 'receipt', 0, '2020-08-30 09:17:02', NULL, NULL),
	(60, NULL, NULL, 131, 'bol', 0, '2020-08-30 09:48:39', 62, NULL),
	(61, 21, NULL, 132, 'bfu', 0, '2020-08-30 09:49:05', NULL, NULL),
	(62, 21, NULL, 133, 'entry', 0, '2020-08-30 09:49:06', NULL, NULL),
	(63, 21, NULL, 134, 'receipt', 0, '2020-08-30 09:49:06', NULL, NULL),
	(64, NULL, NULL, 135, 'bol', 0, '2020-08-30 10:03:37', 63, NULL),
	(65, NULL, 18, 136, 'assurance', 0, '2020-08-30 10:09:58', NULL, NULL),
	(66, NULL, NULL, 137, 'bol', 0, '2020-08-30 11:53:12', 64, NULL),
	(67, NULL, 19, 138, 'assurance', 0, '2020-08-30 12:02:13', NULL, NULL),
	(68, NULL, NULL, 139, 'bol', 0, '2020-08-30 12:12:57', 65, NULL),
	(69, NULL, NULL, 140, 'cin', 0, '2020-08-30 12:17:33', NULL, 20),
	(70, 22, NULL, 141, 'bfu', 0, '2020-08-30 12:17:56', NULL, NULL),
	(71, 22, NULL, 142, 'entry', 0, '2020-08-30 12:17:57', NULL, NULL),
	(72, 22, NULL, 143, 'receipt', 0, '2020-08-30 12:17:57', NULL, NULL),
	(73, NULL, NULL, 144, 'bol', 0, '2020-08-30 22:05:03', 66, NULL),
	(74, 23, NULL, 145, 'bfu', 0, '2020-08-30 22:06:21', NULL, NULL),
	(75, 23, NULL, 146, 'entry', 0, '2020-08-30 22:06:22', NULL, NULL),
	(76, 23, NULL, 147, 'receipt', 0, '2020-08-30 22:06:23', NULL, NULL),
	(77, NULL, NULL, 148, 'bol', 0, '2020-08-31 00:11:28', 67, NULL),
	(78, NULL, NULL, 149, 'bol', 0, '2020-08-31 00:13:55', 68, NULL),
	(79, NULL, NULL, 150, 'bol', 0, '2020-08-31 00:18:25', 69, NULL),
	(80, NULL, NULL, 151, 'bol', 0, '2020-08-31 00:21:06', 70, NULL),
	(81, 24, NULL, 152, 'bfu', 0, '2020-08-31 00:21:37', NULL, NULL),
	(82, 24, NULL, 153, 'entry', 0, '2020-08-31 00:21:38', NULL, NULL),
	(83, 24, NULL, 154, 'receipt', 0, '2020-08-31 00:21:38', NULL, NULL);
/*!40000 ALTER TABLE `demande_file` ENABLE KEYS */;

-- Dumping structure for table usat_benin2.doctrine_migration_versions
...
-- Dumping data for table usat_benin2.doctrine_migration_versions: ~30 rows (approximately)
...
-- Dumping structure for table usat_benin2.file
CREATE TABLE IF NOT EXISTS `file` (
  ...
  CONSTRAINT `FK_8C9F3610A76ED395` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=155 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table usat_benin2.file: ~130 rows (approximately)
...
-- Dumping structure for table usat_benin2.fleet
CREATE TABLE IF NOT EXISTS `fleet` (
  ...
  `created_at` datetime NOT NULL,
  PRIMARY KEY (`id`),
  KEY `IDX_A05E1E47A76ED395` (`user_id`),
  CONSTRAINT `FK_A05E1E47A76ED395` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table usat_benin2.fleet: ~2 rows (approximately)
...
-- Dumping structure for table usat_benin2.home_announce
CREATE TABLE IF NOT EXISTS `home_announce` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- Dumping data for table usat_benin2.home_announce: ~0 rows (approximately)
/*!40000 ALTER TABLE `home_announce` DISABLE KEYS */;
/*!40000 ALTER TABLE `home_announce` ENABLE KEYS */;

-- Dumping structure for table usat_benin2.importer
CREATE TABLE IF NOT EXISTS `importer` (
  ...
  `created_at` datetime NOT NULL,
  PRIMARY KEY (`id`),
  KEY `IDX_64E883E8A76ED395` (`user_id`),
  CONSTRAINT `FK_64E883E8A76ED395` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=41 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table usat_benin2.importer: ~23 rows (approximately)
...
-- Dumping structure for table usat_benin2.manager
CREATE TABLE IF NOT EXISTS `manager` (
  ...
  `register_num` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `IDX_FA2425B94B061DF9` (`fleet_id`),
  CONSTRAINT `FK_FA2425B94B061DF9` FOREIGN KEY (`fleet_id`) REFERENCES `fleet` (`id`),
  CONSTRAINT `FK_FA2425B9BF396750` FOREIGN KEY (`id`) REFERENCES `user` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table usat_benin2.manager: ~10 rows (approximately)
...
INSERT INTO `manager` (`id`, `fleet_id`, `compagny`, `ifu`, `register_num`) VALUES
	...
	(11, 3, 'AD SARLO', '5115645447846', '5s6d4fsd84464f'),
	(12, 3, 'ADE SARL', '5115645d48d46', 'sd6f5d4f6zed9f4'),
	(17, 3, 'AD SARL', '51156454846fdds', '5s6d4fsd864fsd'),
	(28, 4, 'ADE SARL', '5115645ffs4846', '5s6d4fsd864fsfs'),
	(29, 4, 'AD SARL', '51156454ff846', '5s6d4fsd8dd64f'),
	(30, 3, 'AD SARLs', '5115645d4846', '5s6d4fsfd864f'),
	(36, 3, 'ADE SARL', '5115645hfhfg4846', '5s6d4fhfthrtsfd864f'),
	(39, 4, 'SOBAMAR', '51156554454846', 'dfds5d445s'),
	(42, 3, '', NULL, NULL);
/*!40000 ALTER TABLE `manager` ENABLE KEYS */;

-- Dumping structure for table usat_benin2.notification
CREATE TABLE IF NOT EXISTS `notification` (
  ...
  KEY `IDX_BF5476CA537048AF` (`transfer_id`),
  KEY `IDX_BF5476CAA00B94E6` (`removal_id`),
  KEY `IDX_BF5476CA61220EA6` (`creator_id`),
  CONSTRAINT `FK_BF5476CA537048AF` FOREIGN KEY (`transfer_id`) REFERENCES `transfer` (`id`),
  CONSTRAINT `FK_BF5476CA61220EA6` FOREIGN KEY (`creator_id`) REFERENCES `user` (`id`),
  CONSTRAINT `FK_BF5476CAA00B94E6` FOREIGN KEY (`removal_id`) REFERENCES `removal` (`id`),
  CONSTRAINT `FK_BF5476CAA76ED395` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table usat_benin2.notification: ~9 rows (approximately)
...
-- Dumping structure for table usat_benin2.processing
CREATE TABLE IF NOT EXISTS `processing` (
  ...
  `created_at` datetime NOT NULL,
  PRIMARY KEY (`id`),
  KEY `IDX_886CAB2B537048AF` (`transfer_id`),
  KEY `IDX_886CAB2BA00B94E6` (`removal_id`),
  KEY `IDX_886CAB2BA76ED395` (`user_id`),
  CONSTRAINT `FK_886CAB2B537048AF` FOREIGN KEY (`transfer_id`) REFERENCES `transfer` (`id`),
  CONSTRAINT `FK_886CAB2BA00B94E6` FOREIGN KEY (`removal_id`) REFERENCES `removal` (`id`),
  CONSTRAINT `FK_886CAB2BA76ED395` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=56 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table usat_benin2.processing: ~47 rows (approximately)
...
-- Dumping structure for table usat_benin2.profil
CREATE TABLE IF NOT EXISTS `profil` (
  ...
  `slug` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `UNIQ_E6D6B297989D9B62` (`slug`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table usat_benin2.profil: ~5 rows (approximately)
...
-- Dumping structure for table usat_benin2.removal
CREATE TABLE IF NOT EXISTS `removal` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `agent_id` int(11) NOT NULL,
  `vehicle_id` int(11) NOT NULL,
  `remover_id` int(11) NOT NULL,
  `pay_bank_id` int(11) NOT NULL,
  `status` varchar(30) COLLATE utf8mb4_unicode_ci NOT NULL,
  `bfu_num` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `entry_num` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `deleted` tinyint(1) NOT NULL,
  `created_at` datetime NOT NULL,
  `fleet_id` int(11) NOT NULL,
  `reference` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `UNIQ_D4DBB74B545317D1` (`vehicle_id`),
  UNIQUE KEY `UNIQ_D4DBB74B2FFFD108` (`entry_num`),
  KEY `IDX_D4DBB74B3414710B` (`agent_id`),
  KEY `IDX_D4DBB74BE54D128A` (`remover_id`),
  KEY `IDX_D4DBB74BF7223C8A` (`pay_bank_id`),
  KEY `IDX_D4DBB74B4B061DF9` (`fleet_id`),
  CONSTRAINT `FK_D4DBB74B3414710B` FOREIGN KEY (`agent_id`) REFERENCES `agent` (`id`),
  CONSTRAINT `FK_D4DBB74B4B061DF9` FOREIGN KEY (`fleet_id`) REFERENCES `fleet` (`id`),
  CONSTRAINT `FK_D4DBB74B545317D1` FOREIGN KEY (`vehicle_id`) REFERENCES `vehicle` (`id`),
  CONSTRAINT `FK_D4DBB74BE54D128A` FOREIGN KEY (`remover_id`) REFERENCES `remover` (`id`),
  CONSTRAINT `FK_D4DBB74BF7223C8A` FOREIGN KEY (`pay_bank_id`) REFERENCES `bank` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=25 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table usat_benin2.removal: ~21 rows (approximately)
...
-- Dumping structure for table usat_benin2.remover
CREATE TABLE IF NOT EXISTS `remover` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `agent_id` int(11) NOT NULL,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `created_at` datetime NOT NULL,
  PRIMARY KEY (`id`),
  KEY `IDX_4AB84F2C3414710B` (`agent_id`),
  CONSTRAINT `FK_4AB84F2C3414710B` FOREIGN KEY (`agent_id`) REFERENCES `agent` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=21 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table usat_benin2.remover: ~15 rows (approximately)
/*!40000 ALTER TABLE `remover` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `remover` ENABLE KEYS */;

-- Dumping structure for table usat_benin2.reset_password_request
...
-- Dumping data for table usat_benin2.reset_password_request: ~0 rows (approximately)
/*!40000 ALTER TABLE `reset_password_request` DISABLE KEYS */;
/*!40000 ALTER TABLE `reset_password_request` ENABLE KEYS */;

-- Dumping structure for table usat_benin2.ship
...
-- Dumping data for table usat_benin2.ship: ~27 rows (approximately)
...
-- Dumping structure for table usat_benin2.transfer
CREATE TABLE IF NOT EXISTS `transfer` (
  ...
  `reference` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `UNIQ_4034A3C0545317D1` (`vehicle_id`),
  KEY `IDX_4034A3C0783E3463` (`manager_id`),
  CONSTRAINT `FK_4034A3C0545317D1` FOREIGN KEY (`vehicle_id`) REFERENCES `vehicle` (`id`),
  CONSTRAINT `FK_4034A3C0783E3463` FOREIGN KEY (`manager_id`) REFERENCES `manager` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=22 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table usat_benin2.transfer: ~17 rows (approximately)
...
-- Dumping structure for table usat_benin2.user
...
-- Dumping data for table usat_benin2.user: ~19 rows (approximately)
...
INSERT INTO `user` (`id`, `profil_id`, `username`, `roles`, `password`, `name`, `last_name`, `phone`, `email`, `address`, `status`, `created_at`, `last_connection`, `is_verified`, `user_type`) VALUES
	(1, 2, 'admin', '["ROLE_ADMIN"]', '$argon2id$v=19$m=65536,t=4,p=1$c3lFVUZUd1hycjVyNThlUw$ecLmUD/PMALC1+4CH0oMaavZet13tWavrQy3z5rhJJI', 'Admin', 'Admin', '+22997403627', 'admin@admin.com', 'Porto-Novo/Tokpota/C/SB M\\GNACADJA', 0, '2020-08-09 01:38:00', '2020-08-09 01:38:00', 1, 'User'),
	(2, 2, 'geo', '["ROLE_MANAGER"]', '$argon2id$v=19$m=65536,t=4,p=1$c3lFVUZUd1hycjVyNThlUw$ecLmUD/PMALC1+4CH0oMaavZet13tWavrQy3z5rhJJI', 'Geo', 'GANTIN', '+22997403627', 'gmlginoliafs@gmail.com', 'Porto-Novo/Tokpota/C/SB M\\GNACADJA', 1, '2020-08-09 01:38:00', '2020-08-31 00:10:20', 1, 'Manager'),
	(3, 1, 'serge', '["ROLE_AGENT"]', '$argon2id$v=19$m=65536,t=4,p=1$blZnNFZ3WGovQ01VOC82Wg$Cyx+gu0uZeBvIZ9MQkyLbG4FSuqHc4v/y7SM4F063M4', 'Serge', 'GOHOU', '97403627', 'gmlginoddddsslias@gmail.com', 'BENIN/COTONOU', 1, '2020-08-09 01:16:19', '2020-08-31 00:17:44', 1, 'Agent'),
	(4, 2, 'harry', '["ROLE_MANAGER"]', '$argon2id$v=19$m=65536,t=4,p=1$ekhhYlcwVEhGYWVJVHdCNA$4l0qe4XCh+J6v3znPYNcu+oAoc6AZN9kSXCFYeBErGg', 'Harry', 'POTTER', '+22994709576', 'lhounhouedo@gmail.com', 'Porto-Novo/Tokpota/C/SB M\\GNACADJA', 1, '2020-08-16 10:28:01', '2020-08-16 10:28:01', 1, 'Manager'),
	(5, 2, 'ffolabffi', '["ROLE_MANAGER"]', '$argon2id$v=19$m=65536,t=4,p=1$YmMzOGY2elNjRzE5ZFEyVg$YjnKUqBihB0QsUSQL4/qkVPmjNXuJ94u51fjuwJ0830', 'Justin', 'FAGBEHOURO', '+22997983478', 'groupgvgfgfgotsarl@gmail.com', 'Ekpè gare', 1, '2020-08-16 11:13:03', '2020-08-16 11:13:03', 1, 'Manager'),
	(6, 6, 'nel', '["ROLE_STAFF_ADMIN"]', '$argon2id$v=19$m=65536,t=4,p=1$c3lFVUZUd1hycjVyNThlUw$ecLmUD/PMALC1+4CH0oMaavZet13tWavrQy3z5rhJJI', 'Nel', 'GNAC', '+22997974040', 'nel@dev.fr', 'Porto-Novo', 1, '2020-08-20 19:57:57', '2020-08-31 01:08:25', 1, 'User'),
	(9, 4, 'toto', '["ROLE_CONTROL"]', '$argon2id$v=19$m=65536,t=4,p=1$R0ttWHV0aTM3N1IzY3d3NA$Cc2W0kGPUt9vvGjeOv8ZvDFXI2OdgEWq2l1hKcJd7v8', 'Toto', 'FGTRO', '+22997403621', 'toto@nel.fr', 'Porto-Novo/Tokpota/C/SB M\\GNACADJA', 1, '2020-08-25 23:07:00', '2020-08-25 23:23:07', 0, 'User'),
	(10, 3, 'baz', '["ROLE_STAFF"]', '$argon2id$v=19$m=65536,t=4,p=1$TGV3NkoyU0VEYU4wYXI3Sg$cHSa1u9X4TpIfewbcT482vOu5LeKVOBU1NZpkuGDWZA', 'Bazilia', 'ATCHADÉ', '+22997403600', 'baz@net.fr', 'Porto-Novo/Tokpota/C/SB M\\GNACADJA', 1, '2020-08-25 23:09:55', '2020-08-26 02:23:38', 1, 'User'),
	(11, 2, 'lucas', '[]', '$argon2id$v=19$m=65536,t=4,p=1$UmxMN3ZCRFFRRXgvUThDaQ$OcvR3eGtRlWen884KG7Lyb4QLQckqWTkgoyria4al2Y', 'Luc', 'DOUHONO', '+22998949448', 'luc@nel.fr', 'BENIN/COTONOU', 1, '2020-08-29 17:36:48', '2020-08-29 18:27:58', 0, 'Manager'),
	(12, 2, 'gilles', '["ROLE_MANAGER"]', '$argon2id$v=19$m=65536,t=4,p=1$M3pXQWtkVHZ2OWZoZm1jdw$UMIWVS8ob+1StJsXgsT0BAlfJ+2Ec8FzdNvbpD3ruJw', 'Gilles', 'LOKOSSOU', '+22998988585', 'gmlgiddnolias@gmail.com', 'BENIN/COTONOU', 1, '2020-08-29 18:30:59', '2020-08-29 18:36:42', 1, 'Manager'),
	(13, 1, 'alice', '[]', '$argon2id$v=19$m=65536,t=4,p=1$M0doenFBVmxvNWlGaXQzWg$ORdKSchDg3KJAo3yUVmzULooQfjhoBlcE32Rq+Qa+Kg', 'Alice', 'GODO', '97403627', 'gmlgggfinolias@gmail.com', 'BENIN/COTONOU', 1, '2020-08-29 19:00:03', '2020-08-29 19:40:07', 0, 'Agent'),
	(17, 2, 'duc', '["ROLE_MANAGER"]', '$argon2id$v=19$m=65536,t=4,p=1$Nm1DY2F4bzhTYi9kUUtaSg$stlQ2qSgWgvEAWgTmnMvI8QUbblCw5VXpy//egRf1/k', 'Duc', 'DGOR', '97403627', 'gmlginoliggas@gmail.com', NULL, 1, '2020-08-29 19:34:18', '2020-08-29 19:36:13', 1, 'Manager'),
	(28, 2, 'holly', '["ROLE_MANAGER"]', '$argon2id$v=19$m=65536,t=4,p=1$YXRsNWYxNDNUN2QvaVVqUQ$5/prUeJcHJQk4j6giwj297Gfwu0IVExZB8IdoUZPcqk', 'Holly', 'NOETA', '97403627', 'gmlginolias@gmail.com', 'BENIN/COTONOU', 1, '2020-08-29 20:30:58', '2020-08-29 20:33:16', 1, 'Manager'),
	(29, 2, 'deo', '["ROLE_MANAGER"]', '$argon2id$v=19$m=65536,t=4,p=1$WFJ5TXkweWZTczljQVBRSg$aQH1j5Go9JR5UvHXtLP8TT0bNX/bivTQ3uRwiITXYjk', 'Deo', 'GAHOUN', '97403627', 'marnddognac@gmail.com', 'Porto-Novo/Tokpota/C/SB M\\GNACADJA', 1, '2020-08-30 06:34:08', NULL, 1, 'Manager'),
	(30, 2, 'sea', '["ROLE_MANAGER"]', '$argon2id$v=19$m=65536,t=4,p=1$VUJLV2JaMjdWYzhwWGlmTA$P3LmmQe40ULj1uLM7Oqjw2S+X3cXGd+o4+idfePRyJE', 'Sea', 'DOHOU', '97403627', 'marnogsdnac@gmail.com', 'BENIN/COTONOU', 1, '2020-08-30 06:45:57', NULL, 1, 'Manager'),
	(36, 2, 'king', '["ROLE_MANAGER"]', '$argon2id$v=19$m=65536,t=4,p=1$dlI1SFNrd005RUdDekRDZw$RfwXe/dQrfUsm3Mhwo9hsJxucXsqc1MwE3znftSbEw0', 'Ginola', 'GNACADJA', '+22995168586', 'marnogdnac@gmail.com', 'BENIN/COTONOU', 1, '2020-08-30 07:46:05', NULL, 1, 'Manager'),
	(37, 1, 'queen', '["ROLE_AGENT"]', '$argon2id$v=19$m=65536,t=4,p=1$QkJuTXVoSzhFWnNka28zaw$8VEPTM5XZSi+zFmXaJYTAqOefYPARBIv/MT9e5X3V78', 'Celine', 'DION', '97403627', 'marfgfgnognac@gmail.com', 'BENIN/COTONOU', 1, '2020-08-30 07:48:34', '2020-08-30 09:59:28', 1, 'Agent'),
	(38, 6, 'ffolabi', '["ROLE_STAFF_ADMIN"]', '$argon2id$v=19$m=65536,t=4,p=1$ZDFiRktIZVVBaWFWZmFhcw$+Dha5NO9xf5a8ocbS9+RnhORJoesxEdGQsoJ02oUN8o', 'Justin', 'FAGBEHOURO', '+22997983478', 'groupgvotsarl@gmail.com', 'Ekpè gare', 1, '2020-08-30 11:40:01', '2020-08-30 11:40:38', 1, 'User'),
	(39, 2, 'parcgts', '["ROLE_MANAGER"]', '$argon2id$v=19$m=65536,t=4,p=1$RXhELll1S2JtWi5ISnhGSw$EXhtGhlqu5r2WFpAeuNRs6LENZ1jk1G8jELzvojTGAo', 'Ali', 'YOUSSEF', '+22997403627', 'marnogdfgdfnac@gmail.com', 'BENIN/COTONOU', 1, '2020-08-30 11:45:23', '2020-08-30 11:57:52', 1, 'Manager'),
	(40, 1, 'grouptrans', '["ROLE_AGENT"]', '$argon2id$v=19$m=65536,t=4,p=1$Y1hISk9UYmNqYnpRMkFJMw$rUnoVBZ7MgUvKHNbPGHHSo9h6ZIOiyu2c0buM81FrJA', 'Aurelien', 'IDOHOU', '97403627', 'marnognac@gmail.com', 'BENIN/COTONOU', 1, '2020-08-30 12:05:30', NULL, 1, 'Agent'),
	(41, 1, 'hence', '[]', '$argon2id$v=19$m=65536,t=4,p=1$OGZscVd3TVNsZVhXNU1GUQ$NBXax1jlInRfjQ8YKZMS9p2ifHtB1p9TZfRrmabGYVc', 'Hence', 'GEEN', '97403627', 'net@nel.fr', 'BENIN/COTONOU', 1, '2020-08-30 20:42:39', NULL, 0, 'Agent'),
	(42, 2, 'kelly', '[]', '$argon2id$v=19$m=65536,t=4,p=1$LkY0c1NKQ2xCaFhWWXVZbA$UP1896g+LqYlvwJ9Ejav/ycO3hXGhbxMMcvugt5cYgs', 'Kelly', 'HOUSSOU', '+22997403627', 'kelly@neel.fr', 'BENIN/COTONOU', 1, '2020-08-30 21:05:54', NULL, 0, 'Manager'),
	(43, 1, 'kohn', '[]', '$argon2id$v=19$m=65536,t=4,p=1$c3lSTFh2ZklZdERDREtIYQ$6Pe5wxH0lD0mEuLQctmVfpFp6iT7Rmqb+uHUeOQ0N0M', 'Kohn', 'FASSASSI', '97403627', 'marnognarc@gmail.com', 'BENIN/COTONOU', 1, '2020-08-30 21:07:25', NULL, 0, 'Agent');
/*!40000 ALTER TABLE `user` ENABLE KEYS */;

-- Dumping structure for table usat_benin2.vehicle
CREATE TABLE IF NOT EXISTS `vehicle` (
  ...
  KEY `IDX_1B80E486C256317D` (`ship_id`),
  KEY `IDX_1B80E4867FCFE58E` (`importer_id`),
  KEY `IDX_1B80E486A76ED395` (`user_id`),
  KEY `IDX_1B80E486E54D128A` (`remover_id`),
  CONSTRAINT `FK_1B80E48644F5D008` FOREIGN KEY (`brand_id`) REFERENCES `brand` (`id`),
  CONSTRAINT `FK_1B80E4867FCFE58E` FOREIGN KEY (`importer_id`) REFERENCES `importer` (`id`),
  CONSTRAINT `FK_1B80E486A76ED395` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`),
  CONSTRAINT `FK_1B80E486C256317D` FOREIGN KEY (`ship_id`) REFERENCES `ship` (`id`),
  CONSTRAINT `FK_1B80E486E54D128A` FOREIGN KEY (`remover_id`) REFERENCES `remover` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=71 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table usat_benin2.vehicle: ~49 rows (approximately)
